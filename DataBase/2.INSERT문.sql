...
TRUNCATE TABLE toy_shop2; -- TRUNCATE TABLE은 행을 제거하는 문 -- TRUNCATE TABLE은 행을 제거하는 문
...
-- 주의점
-- > SELECT문의 결과 데이터의 열 갯수는 INSERT할 테이블의 열 갯수와 같아야 함

-- WORLD 데이터베이스의 city 테이블의 데이터 갯수 조회
SELECT COUNT(*) FROM world.city;

-- world.city 테이블 프로퍼티 보기
DESC world.city; -- 여기서 DESC는 describe를 의미함
...
-- 만약에 'New'로 시작하는 도시 중 상위 몇 건만 삭제하려면 LIMIT과 함꼐 사용할 수 있음
